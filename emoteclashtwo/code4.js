...
gdjs.Game_32SceneCode.GDRepeatingBackgroundObjects3= [];
gdjs.Game_32SceneCode.GDPlayer3DoObjects1= [];
gdjs.Game_32SceneCode.GDPlayer3DoObjects2= [];
gdjs.Game_32SceneCode.GDPlayer3DoObjects3= [];
...
gdjs.Game_32SceneCode.GDCursorObjects3= [];
...
gdjs.Game_32SceneCode.GDCamera2Objects3= [];
...
gdjs.copyArray(gdjs.Game_32SceneCode.GDEnemy2Objects1, gdjs.Game_32SceneCode.GDEnemy2Objects2);

{for(var i = 0, len = gdjs.Game_32SceneCode.GDEnemy2Objects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDEnemy2Objects2[i].setFaceResourceName("front", "Clown.png");
}
}
}
...
{for(var i = 0, len = gdjs.Game_32SceneCode.GDEnemy2Objects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDEnemy2Objects2[i].setFaceResourceName("front", "PurpleDemon.png");
}
}
}
...
{for(var i = 0, len = gdjs.Game_32SceneCode.GDEnemy2Objects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDEnemy2Objects2[i].setFaceResourceName("front", "Cowboy.png");
}
}
}
...
{for(var i = 0, len = gdjs.Game_32SceneCode.GDEnemy2Objects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDEnemy2Objects2[i].setFaceResourceName("front", "SwearingAngry.png");
}
}
}
...
{for(var i = 0, len = gdjs.Game_32SceneCode.GDEnemy2Objects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDEnemy2Objects2[i].setFaceResourceName("front", "Skully.png");
}
}
}
...
{gdjs.evtTools.firebaseTools.analytics.log("Game", "");
}
}
...
gdjs.Game_32SceneCode.GDRepeatingBackgroundObjects3.length = 0;
gdjs.Game_32SceneCode.GDPlayer3DoObjects1.length = 0;
gdjs.Game_32SceneCode.GDPlayer3DoObjects2.length = 0;
gdjs.Game_32SceneCode.GDPlayer3DoObjects3.length = 0;
...
gdjs.Game_32SceneCode.GDCursorObjects3.length = 0;
...
gdjs.Game_32SceneCode.GDCamera2Objects3.length = 0;
